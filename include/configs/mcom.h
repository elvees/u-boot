...
#if defined(CONFIG_TARGET_ECAM02DM) || defined(CONFIG_TARGET_ECAM02DM31)
...
#define CFG_SYS_NS16550_CLK		(SPLL_FREQ >> DIV_SYS1_CTR_VALUE)
#define CONFIG_SYS_NS16550_REG_SIZE	-4
#define CFG_SYS_NS16550_COM1		0x38028000
#define CFG_SYS_NS16550_COM2		0x38029000
#define CFG_SYS_NS16550_COM3		0x3802A000
#define CFG_SYS_NS16550_COM4		0x3802B000
...
#define CFG_DW_WDT_CLOCK_KHZ	((SPLL_FREQ >> DIV_SYS1_CTR_VALUE) / 1000)
#endif
...
#define BOOT_TARGET_DEVICES_UBIFS(func) func(UBIFS, ubifs, 0, 0, boot)
#else
...
defined(CONFIG_TARGET_ECAM02DM3) || defined(CONFIG_TARGET_ECAM02DM31)
