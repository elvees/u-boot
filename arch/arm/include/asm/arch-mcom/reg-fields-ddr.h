...
#define DFITMG1_DRAM_CLK_EN       GENMASK(3, 0)
#define DFITMG1_DRAM_CLK_DIS      GENMASK(11, 8)
#define DFITMG1_WRDATA_DELAY      GENMASK(20, 16)
...
#define DXGCR_DQSRTT              BIT(9)
#define DXGCR_DQRTT               BIT(10)
